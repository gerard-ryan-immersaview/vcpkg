...
foreach(script IN LISTS GLIB_SCRIPTS)
    ...
    elseif(VCPKG_BUILD_TYPE STREQUAL "debug")
        file(RENAME "${CURRENT_PACKAGES_DIR}/debug/bin/${script}" "${CURRENT_PACKAGES_DIR}/tools/${PORT}/${script}")
...
elseif(VCPKG_BUILD_TYPE STREQUAL "debug")
    vcpkg_copy_tools(TOOL_NAMES ${GLIB_TOOLS} SEARCH_DIR "${CURRENT_PACKAGES_DIR}/debug/bin" AUTO_CLEAN)
endif()
